...
package com.zyqhi.applock.lockpattern;
...
import com.zyqhi.applock.lockpattern.LinearLayoutWithDefaultTouchRecepient;
import com.zyqhi.applock.lockpattern.LockPatternUtils;
import com.zyqhi.applock.lockpattern.LockPatternView;
...
public class ConfirmLockPattern extends Activity {
     ...
     */
    public static final String HEADER_TEXT = "com.zyqhi.applockphone.header";
    public static final String FOOTER_TEXT = "com.zyqhi.applockphone.footer";
    public static final String HEADER_WRONG_TEXT = "com.zyqhi.applockphone.header_wrong";
    public static final String FOOTER_WRONG_TEXT = "com.zyqhi.applockphone.footer_wrong";
    public static final String DISABLE_BACK_KEY = "com.zyqhi.applockphone.ConfirmLockPattern.disable_back_key";
    ...
    private LockPatternView.OnPatternListener mConfirmExistingLockPatternListener = new LockPatternView.OnPatternListener()  {
        ...
        public void onPatternDetected(List<LockPatternView.Cell> pattern) {
        	Toast.makeText(getApplicationContext(), "CheckPattern", Toast.LENGTH_SHORT).show();
            if (mLockPatternUtils.checkPattern(pattern)) {
            	Toast.makeText(getApplicationContext(), "Pattern matched", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            } else {
            	Toast.makeText(getApplicationContext(), "Pattern mismatched", Toast.LENGTH_SHORT).show();
    ...
    @Override
    public void finish() {
    	Toast.makeText(getApplicationContext(), "I have finished", Toast.LENGTH_SHORT).show();
        super.finish();
