...
public class LockPatternUtils {
	...
	public void setTactileFeedbackEnabled(boolean enabled) {
		setBoolean(Settings.System.LOCK_PATTERN_TACTILE_FEEDBACK_ENABLED,
				enabled);
	}
	 ...
	 * user must authenticate via other means. If false, that means the user has
	 * gone out of permanent lock, so the existing (forgotten) lock pattern
	 * needs to be cleared.
	 * 
	 * @param locked
